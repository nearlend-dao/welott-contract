...
pub const ERR23_LOTTERY_NOT_CLAIMABLE: &str = "E23: Lottery not claimable";
...
pub const ERR45_MINIMUM_TIME_FOR_RUN_LOTTERY: &str =
    "E44: Minimum time for run lottery is 10 hours";
